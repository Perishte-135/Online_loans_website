    ...
    <div className="container">
      <div className="online_loans">
        <header className="header">
          ...
          <div className="nav">
            <ul className="menu">
              <li className="menu_item">Получить деньги</li>
              <li className="menu_item">Клиентам</li>
      ...
      <div className="get_money_desc">
        ...
        <p>Мы ценим ваше время и дорожим вашими потребностями, поэтому предлагаем быстрые и выгодные условия для всех клиентов. Наша команда профессионалов готова помочь вам решить ваши финансовые вопросы и предложить оптимальные варианты займа. Обращайтесь к нам, и мы поможем вам решить ваши финансовые трудности надежно и быстро.</p>
      </div>
      <div className="why_us_block">
        ...
        <div className="general_block">
          <div className="no_change_owner">
            ...
            <p>Жилье остается у владельца — не требуется переоформлять недвижимость на банк и аннулировать регистрацию</p>
            <i className="note"></i>
          </div>
      ...
      <div className="reviews_block">
        ...
        <div className="first_three_reviews">
          <div className="first_review">
            ...
            <p className="review">Обращалась за займом под залог дома. Сотрудники компании очень внимательные и компетентные. Все объяснили подробно и помогли оформить документы. Спасибо за вашу помощь!</p>
          ...
          <div className="second_review">
            ...
            <p className="review">Мне срочно нужны были деньги на лечение. В этой компании мне одобрили заем под залог квартиры всего за один день. Очень выручили в трудной ситуации.</p>
            <i className="overElipse"></i>
            <i className="innerElipse"></i>
            <i className="polygon"></i>
          </div>
          <div className="third_review">
            ...
            <p className="review">Мне срочно понадобились деньги на ремонт машины. Обратился в эту компанию, и мне быстро одобрили заем под залог квартиры. Процентная ставка приемлемая, а условия договора прозрачные. Рекомендую!</p>
            <i className="overElipse"></i>
            <i className="innerElipse"></i>
            <i className="polygon"></i>
          </div>
        ...
        <div className="second_three_reviews">
          <div className="fourth_review">
            ...
            <p className="review">Брала здесь заем на покупку новой квартиры. Условия оказались выгоднее, чем в других компаниях. Оформление прошло быстро и без лишней бюрократии.</p>
            <i className="overElipse"></i>
            <i className="innerElipse"></i>
            <i className="polygon"></i>
          </div>
          <div className="fifth_review">
            ...
            <p className="review">Брал здесь заем на развитие бизнеса. Оценили недвижимость оперативно, деньги получил на следующий день. Удобный график платежей и вежливое обслуживание.</p>
            <i className="overElipse"></i>
            <i className="innerElipse"></i>
            <i className="polygon"></i>
          </div>
          <div className="sixth_review">
            ...
            <p className="review">Обращалась в эту компанию дважды. Оба раза получила займы быстро и без проблем. Рекомендую всем, кому срочно нужны деньги.</p>
            <i className="overElipse"></i>
            <i className="innerElipse"></i>
            <i className="polygon"></i>
          </div>
      ...
      <div className="asked_questions_block">
      ...
      <div className="apply_for_loan_block">
        ...
        <div className="apply_for_loan">
          <button className="apply_loan_btn">Оформить заявку</button>
        </div>
      </div>
    </div>
  )
